    ...
    return (
        <>
            ...
            <div className="flex h-full flex-1 flex-col gap-5 p-4">
                <PageHeader title="Edit Vendor" description={vendor.name} />

                <Form {...update.form({ vendor: vendor.id })} className="max-w-lg space-y-5 rounded-xl border bg-card p-6 shadow-xs">
                    {({ processing, errors }) => (
                        <>
